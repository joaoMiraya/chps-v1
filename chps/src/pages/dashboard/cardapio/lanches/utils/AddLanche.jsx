...
function AddLanche() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("Ocorreu um erro ao adiconar o lanche:", error);
        }
    }
    //FUNÇÃO RESPOSAVEL PELO UPLOAD DA IMAGEM... PASSAR A LÓGICA PARA O REDUX
    const handleImageChange = async (e) => {
        const file = e.target.files[0];
        const lancheImagesRef = ref(storage, `/items-images/lanche-images/${file.name}`);
    ...
    return (
        ...
        <form onSubmit={handleSubmit} >
            <div className="flex flex-col gap-2 mt-6">
                ...
                <button type="submit" disabled={submiting} className="bg-[#DB0007] hover:opacity-75 text-white font-semibold py-2 rounded-md">
                    {submiting ?
