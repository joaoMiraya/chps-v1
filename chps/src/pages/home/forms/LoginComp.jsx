...
function LoginComp({ handleShowPassword, showPass }) {
    ...
    return (
        <div className="container flex flex-col items-center">
            <h1 className="text-2xl font-bold">Entrar em Chapas</h1>
            <p className="font-semibold">Entrar com:  </p>
            <div className="flex gap-4 ">
                <div className="flex xl:flex-col gap-4 mt-2 ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} >
                <div className="flex flex-col w-screen md:max-w-[50rem] px-8">
