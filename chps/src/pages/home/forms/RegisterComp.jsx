    ...
    return (
        <div className="container flex flex-col  items-center pt-16">
            ...
            <div className="flex xl:flex-col xl:-w xl:flex-grow- gap-4 mt-4 ">
                <div aria-label='Botão para registrar com a conta Google' className="h-16 w-16 flex xl:pr-2 xl:justify-between justify-center  items-center text-sm  rounded-md xl:w-[18rem] border-[1px] border-solid border-gray-400">
                ...
                <div aria-label='Botão para registrar com a conta no Facebook' className="h-16 w-16 flex xl:pr-2 xl:justify-between justify-center items-center text-sm  rounded-md xl:w-[18rem] border-[1px] border-solid border-gray-400">
                ...
                <div aria-label='Botão para registrar com a conta Apple' className="h-16 w-16 flex xl:pr-2 xl:justify-between justify-center items-center text-sm  rounded-md xl:w-[18rem] border-[1px] border-solid border-gray-400">
