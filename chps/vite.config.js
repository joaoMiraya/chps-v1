...
export default defineConfig({
  resolve: {
    alias: {
      "@lanches": "/src/pages/cardapio/lanche",
      "@pizzas": "/src/pages/cardapio/pizza",
      "@porcoes": "/src/pages/cardapio/porcao",
      "@pratos": "/src/pages/cardapio/pratos",
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        dir: "ltr",
        scope_extensions: [
          { "origin": "*.chapas-lanches.com.br" },
          { "origin": "*.chps-database.web.app" },
          { "origin": "www.chapas-lanches.com.br" },
          { "origin": "chapas-lanches.com.br" }
        ],
        display: "standalone",
        display_override: [
        ...
        shortcuts: [
          ...
          },
          {
            name: "Perfil",
            url: "/perfil",
            description: 'Seu perfil no Chapas',
            icons: [
              {
                src: "android/android-launchericon-96-96.png",
                type: "image/png",
          ...
          },
          {
            name: "Menu",
            url: "/menu",
            description: 'Cardápio do Chapas',
            icons: [
              {
                src: "android/android-launchericon-96-96.png",
                type: "image/png",
